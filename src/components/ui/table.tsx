...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-[14px] border border-border">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-11 px-4 text-left align-middle font-medium text-slate [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-sm text-slate", className)}
    {...props}
  />
));
