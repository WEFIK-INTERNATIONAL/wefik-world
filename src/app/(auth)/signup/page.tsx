      ...
      <Card className="w-full max-w-md border-border shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate">
            ...
            Click the link to activate your wefik.world account and continue.
          </CardDescription>
        </CardHeader>
  ...
  return (
    <Card className="w-full max-w-md border-border shadow-lg">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription className="text-slate">
          Get instant access to free templates, purchase themes, and manage your licenses.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSignup} className="space-y-3">
          <div className="space-y-1">
            <label htmlFor="fullName" className="text-xs font-semibold text-slate">
              Full Name
            </label>
            <Input
              id="fullName"
          ...
          <div className="flex items-start space-x-2 pt-1">
            ...
            <label
              htmlFor="terms"
              className="text-xs text-slate leading-tight cursor-pointer select-none"
            >
              I agree to the Terms of Service, License Agreement, and Privacy Policy.
            </label>
          </div>
      ...
      <CardFooter className="flex justify-center text-xs text-slate">
        Already have an account?{' '}
        <Link
          href={`/login?redirect=${encodeURIComponent(redirectUrl)}`}
          className="text-deep-green font-semibold hover:underline ml-1"
        >
          Sign in
        </Link>
      </CardFooter>
